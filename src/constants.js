...
const sectionsDefaultMap = {
  introSection: `<div id="introSection" class="sectionDiv"><p style="margin-top: 0pt; margin-bottom: 0pt;"><span style="font-size: 13pt; font-family: Arial;">Oslash Private Limited</span><span style="font-size: 11pt; font-family: Arial;"> </span></p>
    ...
    <p style="margin-top: 12pt; margin-bottom: 12pt;"><span style="font-size: 13pt; font-family: Arial;">{{{orgName}}} is committed to safeguard the information and other assets shared with us by our customers, partners, and staff. They depend on us to protect their resources. Thus, it is crucial for all {{{orgName}}} staff to understand how to responsibly use our systems such that we can protect the security, availability and confidentiality of such assets.</span></p></div>`,
  // variables: ["orgName", "appName"],

  principleSection: `<div id="principleSection" class="sectionDiv"><p style="margin-top: 0pt; margin-bottom: 0pt;"><span style="font-size: 17pt; font-family: Arial;">Principle &amp; Purpose</span><span style="font-size: 11pt; font-family: Arial;"> </span><span style="font-size: 11pt; font-family: Arial;"> </span><span style="font-size: 11pt; font-family: Arial;"> </span><span style="font-size: 11pt; font-family: Arial;"> </span></p>
    <p style="margin-top: 12pt; margin-bottom: 12pt;"><span style="font-size: 13pt; font-family: Arial;">{{{orgName}}} has a culture of trust and integrity. This policy aims to reinforce the trust we place in each other, by ensuring we can collectively depend on each other to protect the assets of our staff, company, partners and customers.</span><span style="font-size: 11pt; font-family: Arial;"> </span><span style="font-size: 11pt; font-family: Arial;"> </span><span style="font-size: 11pt; font-family: Arial;"> </span><span style="font-size: 11pt; font-family: Arial;"> </span><span style="font-size: 11pt; font-family: Arial;"> </span></p></div>`,

  // variables: ["orgName"],

  scopeSection: `<div id="scopeSection" class="sectionDiv"><p style="margin-top: 12pt; margin-bottom: 12pt;"><span style="font-size: 15pt; font-family: Arial;">Scope</span><span style="font-size: 11pt; font-family: Arial;"> </span><span style="font-size: 11pt; font-family: Arial;"> </span><span style="font-size: 11pt; font-family: Arial;"> </span><span style="font-size: 11pt; font-family: Arial;"> </span></p>
  ...
  // seperationOfConcernSection: `<div id="seperationOfConcernSection" class="sectionDiv"><p style="margin-top: 12pt; margin-bottom: 12pt;"><span style="font-size: 11pt; font-family: Arial;"> </span><span style="font-size: 11pt; font-family: Arial;"> </span><span style="font-size: 11pt; font-family: Arial;"> </span><span style="font-size: 11pt; font-family: Arial;"> </span><span style="font-size: 11pt; font-family: Arial;"> </span></p>
...
module.exports = { sectionTemplate, sectionsDefaultMap };
